...
// =============================================================================
// Simple stop model for numbered passenger pickup points on the driver's route.
// =============================================================================
class RouteStop {
  final int number;
...
class _DriverMapScreenState extends State<DriverMapScreen> {
  ...
  int _currentNavIndex = 1; // Map tab selected

  // Mock start point and driver's current position (Mexico area, Addis Ababa).
  static const LatLng startPoint = LatLng(9.0092, 38.7469);
  static const LatLng driverPosition = LatLng(9.0110, 38.7472);

  // Mock numbered pickup stops along the route toward Bole.
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              '${widget.passengersOnBoard} / ${widget.passengersTotal} passengers • ~${widget.etaMinutes} min',
  ...
  // ---------------------------------------------------------------------------
  // Map: numbered pickup stops, start marker, driver's taxi marker
  // ---------------------------------------------------------------------------
  Widget _buildMap() {
    return Container(
        ...
        children: [
            ...
            children: [
              ...
              MarkerLayer(
                markers: [
                  ...
                  Marker(
                    point: LatLng(stops.last.latitude, stops.last.longitude),
                    width: 70,
                    height: 60,
          ...
          Positioned(
            ...
            child: _buildMapButton(
              Icons.my_location,
              filled: true,
              onTap: () => _mapController.move(driverPosition, 14.5),
            ),
          ),
        ],
      ),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(color: startGreen, borderRadius: BorderRadius.circular(8)),
          child: const Text('Start', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: Colors.white)),
        ),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Text(widget.toLabel, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: Colors.white)),
        ),
      ],
    );
  }
  ...
  // ---------------------------------------------------------------------------
  // Call Passenger / Message action row
  // ---------------------------------------------------------------------------
          ...
          Expanded(
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('Call Passenger', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
          ...
          Expanded(
            child: SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                icon: const Icon(Icons.chat_bubble_outline_rounded, size: 18, color: Colors.black87),
